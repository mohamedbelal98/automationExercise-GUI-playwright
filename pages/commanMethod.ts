...
export class CommanMethod {
  ...
  constructor(page: Page) {
    ...
    this.subscriptionEmaillAddress =
      this.page.getByPlaceholder('Your email address');
  ...
  async takeScreenShot(testName: string) {
    await this.page.screenshot({
      path: `screenshots/${testName}${this.randomNumber}.png`,
    });
  }
  ...
  async verifySubscription() {
    ...
    await expect(this.subscriptionTextLocator).toHaveText('Subscription');
  }
