...
export class ContactUs {
    ...
    constructor(page: Page) {
        this.page = page
        this.successMessageContent = "Success! Your details have been submitted successfully."
        ...
        this.successMessage = this.page.locator("[class='status alert alert-success']")
    }
    ...
    async checkThatSuccessMessageDisplaedCorrectly() {
        ...
        expect(await this.successMessage.textContent()).toEqual(this.successMessageContent)
    }
